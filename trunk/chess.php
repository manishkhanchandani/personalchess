...
$query_rsView = sprintf("SELECT * FROM games WHERE pid = %s ORDER BY id ASC", GetSQLValueString($colname_rsView, "int"));
...
mysql_select_db($database_conn, $conn);
$query_rsSelf = sprintf("SELECT * FROM games WHERE id = %s", GetSQLValueString($colname_rsSelf, "int"));
...
<table border="1" cellspacing="0" cellpadding="5">
	<?php do { ?>
		<tr>
			...
			<td><a href="chess.php?pid=<?php echo $row_rsSelf['pid']; ?>"><?php echo $row_rsSelf['pid']; ?></a>&nbsp;</td>
		</tr>
