...
$moves = trim($_GET['moves']);
	...
	if ($result[0] == 0) {
		...
		$query = sprintf("INSERT INTO finalgames_W SET move = %s, fen = %s, fenpost = %s, moveby = %s, result = %s, process = %s, played_by = 'Stockfish'", GetSQLValueString($move2, "text"), GetSQLValueString($fen, "text"), GetSQLValueString($renderFen, "text"), GetSQLValueString($toMove, "text"), GetSQLValueString($result, "text"), GetSQLValueString($process, "int"));
